...
public class Magpie4
{
	...
	public String getResponse(String statement)
	{
		...
		}else if(findKeyword(statement, "Mr. Mauro") >= 0 || findKeyword(statement, "Mauro") >= 0){
	...
	private String IYouStatement(String statement){
		...
		int psn2 = findKeyword(statement, "you", 1);
		String restOfStatement = statement.substring(2, psn2).trim();
